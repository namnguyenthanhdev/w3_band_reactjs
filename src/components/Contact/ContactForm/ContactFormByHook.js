...
export default function ContactFormByHook(props) {
    ...
    function isError() {
        console.log('test:', Object.keys(errors).length);
    ...
    return (<form onSubmit={handleSubmit(onSubmit, onError)}
        ...
        <FormUnitComponent labelName={"Gender"} className={styles.formUnit}>
            <select
                    name={FormUnitName.GENDER}
                    className={errors && errors[FormUnitName.GENDER] && styles.errorBorder}
                    {...register("Gender", {
        ...
        <FormUnitComponent labelName={"Age"} className={styles.formUnit}>
            <select name={FormUnitName.AGE}
                    className={errors && errors[FormUnitName.AGE] && styles.errorBorder}
                    {...register("Old range", {
                        required: "This field is required"
                    })}>
        ...
        <FormUnitComponent labelName={"Email"} className={styles.formUnit}>
            ...
            <input type="text"
                   name={FormUnitName.EMAIL}
                   className={errors && errors[FormUnitName.EMAIL] && styles.errorBorder}
                   placeholder="Email"
                   {...register("Email", {
        ...
        <FormUnitComponent labelName={"Phone"} className={styles.formUnit}>
            <input name={FormUnitName.PHONE}
                   type="tel"
                   className={errors && errors[FormUnitName.PHONE] && styles.errorBorder}
        ...
        <FormUnitComponent labelName={"Feedback"} className={styles.formUnit}>
            <textarea name={FormUnitName.FEEDBACK}
                      className={errors && errors[FormUnitName.FEEDBACK] && styles.errorBorder}
